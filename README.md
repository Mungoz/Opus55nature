...
- **Water features**: a hanging valley pours over a tiered rock step as a waterfall with drifting spray. Below it a stream meanders across the meadow to the lake, undercutting steep earth banks on the outside of its bends and dropping gravel bars on the inside. Three irregular peaty pools lie in the meadows. Around them grow yellow water-lily colonies, bottle-sedge tussocks, soft rush, water horsetail and cotton grass.
- **Forest**: about 140,000 procedurally modelled spruces, larches, Swiss stone pines, birches, aspens, rowans and standing dead snags. Near trees are instanced meshes with wind sway, translucency and cascaded shadows; distant ones are baked impostor billboards with normal maps, crossfaded by dithering. The forest floor has bracken, bilberry heath, fly agaric and penny bun mushrooms, and sculpted deadwood: flared, fluted stumps and fallen trunks with peeling bark, end grain, snapped stubs, moss cushions and upturned root plates. The deadwood is meshed from distance fields in web workers while the world loads.
