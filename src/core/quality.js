...
export const PRESETS = {
	low: {
		...
		terrainSpacing: 3.5, bloom: true, rays: false, particles: 0.4, fur: 0,
	},
	medium: {
		...
		terrainSpacing: 2.6, bloom: true, rays: true, particles: 0.7, fur: 8,
	},
	high: {
		...
		terrainSpacing: 2, bloom: true, rays: true, particles: 1, fur: 12,
	},
	ultra: {
		...
		terrainSpacing: 1.5, bloom: true, rays: true, particles: 1, fur: 16,
	},
};
