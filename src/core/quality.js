...
export const PRESETS = {
	low: {
		...
		terrainSpacing: 3.5, bloom: true, rays: false, particles: 0.4,
	},
	medium: {
		...
		terrainSpacing: 2.6, bloom: true, rays: true, particles: 0.7,
	},
	high: {
		...
		terrainSpacing: 2, bloom: true, rays: true, particles: 1,
	},
	ultra: {
		...
		terrainSpacing: 1.5, bloom: true, rays: true, particles: 1,
	},
};
